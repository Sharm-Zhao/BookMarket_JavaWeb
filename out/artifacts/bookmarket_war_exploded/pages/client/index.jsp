	...
	<Script type="text/javascript">
		$(function () {
			...
			$("button.addToCart").click(function () {
				...
				location.href = "http://localhost:8080/bookmarket_war_exploded/cartServlet?action=addItem&id=" + bookId;
				// 发ajax请求，添加商品到购物车
...
<%--			<img class="logo_img" alt="" src="static/img/logo.gif" >--%>
			<span class="wel_word">小鸣小室书屋</span>
			<div>
				...
				<c:if test="${not empty sessionScope.user}">
					<span>欢迎<span class="um_span">${sessionScope.user.username}</span>光临小鸣小室</span>
